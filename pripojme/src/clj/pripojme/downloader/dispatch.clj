(ns pripojme.downloader.dispatch
  (:require [pripojme.downloader.solidus-tech-dth :as dth]
            [pripojme.downloader.rising-hf-sensor :as rhf]
            [pripojme.downloader.logarex :as lgx]
            [pripojme.downloader.adeunis-hf :as ade]
            [pripojme.downloader.develict-desense :as des]))
